      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <section className="relative pt-16 pb-20 sm:pt-24 md:pt-28">
          ...
          >
            ...
            >
              ...
              Build a landing page by chatting
            </motion.div>
            ...
            <div className="flex flex-col items-center gap-3">
              <motion.div variants={heroItem}>
                <Image
                  src={sunsetLogoTree}
                  alt="Sunset — AI landing page builder"
                  width={48}
                  height={48}
                  priority
              ...
              >
                Describe it. Sunset designs, builds, and ships a
                conversion-focused landing page in seconds — no templates, no
                drag-and-drop.
              </motion.p>
            </div>
              ...
              >
                ...
                <div className="relative min-h-[4.5rem] text-left">
                  ...
                  <TextareaAutosize
                    ...
                    maxRows={8}
                    placeholder={
                      isFocused ? "Make a landing page for my business" : ""
                    }
        ...
        >
          <div className="mb-10 text-center">
            ...
            >
              Ship a landing page in three steps
            </motion.h2>
            <motion.p
              variants={heroItem}
